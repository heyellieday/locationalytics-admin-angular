...
App.controller('DataTableController', function($scope, $timeout) {
  'use strict';
...
App.controller('FileUploadController', function() {
  'use strict';
...
App.controller('FlotChartController', ['$window','$http', function($window, $http) {
  'use strict';
 ...
 * Initializes the notifications system
 =========================================================*/
App.controller('NotificationController', function($scope, $routeParams){
...
App.controller('VectorMapController', function($scope) {
  'use strict';
